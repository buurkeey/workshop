...
Login_Logout
    ...
    Comment    SauceLabs    Open Application    ${REMOTE_URL}    platformName=${PLATFORM_NAME}    platformVersion=${PLATFORM_VERSION}    app=${APP}
    ...    deviceName=${DEVICE_NAME}    deviceOrientation=${DEVICE_ORIENTATION}    appiumVersion=${APPIUM_VERSION}    browserName=${BROWSER_NAME}
    Comment    Min requirements    Open Application    ${REMOTE_URL}    platformName=${PLATFORM_NAME}    deviceName=${DEVICE_NAME}
